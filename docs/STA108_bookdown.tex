...
\begin{Highlighting}[]
\CommentTok{# R^2}
\CommentTok{# Simulate data from a new model}
\NormalTok{n=}\DecValTok{100}\NormalTok{;}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{X=}\KeywordTok{matrix}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(n}\OperatorTok{*}\DecValTok{4}\NormalTok{),}\DataTypeTok{nrow=}\NormalTok{n,}\DataTypeTok{ncol=}\DecValTok{4}\NormalTok{);}
\NormalTok{y=X}\OperatorTok{%*%}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{)}\OperatorTok{+}\DecValTok{4}\OperatorTok{*}\KeywordTok{rnorm}\NormalTok{(n);}
\NormalTok{Z=}\KeywordTok{matrix}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(n}\OperatorTok{*}\DecValTok{10}\NormalTok{),}\DataTypeTok{nrow=}\NormalTok{n,}\DataTypeTok{ncol=}\DecValTok{10}\NormalTok{)}



\NormalTok{P=}\KeywordTok{calculate.hat}\NormalTok{(}\DataTypeTok{covariate=}\NormalTok{X);}
\NormalTok{P.Z=}\KeywordTok{calculate.hat}\NormalTok{(}\DataTypeTok{covariate=}\KeywordTok{cbind}\NormalTok{(X,Z));}

\NormalTok{n=}\KeywordTok{length}\NormalTok{(y);J=}\KeywordTok{matrix}\NormalTok{(}\DecValTok{1}\NormalTok{,n,n);I=}\KeywordTok{diag}\NormalTok{(n)}


\NormalTok{R.sq =}\KeywordTok{t}\NormalTok{(y)}\OperatorTok{%*%}\NormalTok{(P}\OperatorTok{-}\NormalTok{J}\OperatorTok{/}\NormalTok{n)}\OperatorTok{%*%}\NormalTok{y}\OperatorTok{/}\KeywordTok{t}\NormalTok{(y)}\OperatorTok{%*%}\NormalTok{(I}\OperatorTok{-}\NormalTok{J}\OperatorTok{/}\NormalTok{n)}\OperatorTok{%*%}\NormalTok{y;}
...
\NormalTok{R.sq.adj=}\DecValTok{1}\OperatorTok{-}\NormalTok{(}\KeywordTok{t}\NormalTok{(y)}\OperatorTok{%*%}\NormalTok{(I}\OperatorTok{-}\NormalTok{P)}\OperatorTok{%*%}\NormalTok{y}\OperatorTok{/}\NormalTok{(n}\OperatorTok{-}\KeywordTok{dim}\NormalTok{(X)[}\DecValTok{2}\NormalTok{]}\OperatorTok{-}\DecValTok{1}\NormalTok{) )}\OperatorTok{/}\NormalTok{(}\KeywordTok{t}\NormalTok{(y)}\OperatorTok{%*%}\NormalTok{(I}\OperatorTok{-}\NormalTok{J}\OperatorTok{/}\NormalTok{n)}\OperatorTok{%*%}\NormalTok{y}\OperatorTok{/}\NormalTok{(n}\OperatorTok{-}\DecValTok{1}\NormalTok{));}

\NormalTok{R.sq.Z.adj=}\DecValTok{1}\OperatorTok{-}\NormalTok{(}\KeywordTok{t}\NormalTok{(y)}\OperatorTok{%*%}\NormalTok{(I}\OperatorTok{-}\NormalTok{P.Z)}\OperatorTok{%*%}\NormalTok{y}\OperatorTok{/}\NormalTok{(n}\OperatorTok{-}\KeywordTok{dim}\NormalTok{(X)[}\DecValTok{2}\NormalTok{]}\OperatorTok{-}\KeywordTok{dim}\NormalTok{(Z)[}\DecValTok{2}\NormalTok{]}\OperatorTok{-}\DecValTok{1}\NormalTok{) )}\OperatorTok{/}\NormalTok{(}\KeywordTok{t}\NormalTok{(y)}\OperatorTok{%*%}\NormalTok{(I}\OperatorTok{-}\NormalTok{J}\OperatorTok{/}\NormalTok{n)}\OperatorTok{%*%}\NormalTok{y}\OperatorTok{/}\NormalTok{(n}\OperatorTok{-}\DecValTok{1}\NormalTok{));}
\end{Highlighting}
\end{Shaded}
